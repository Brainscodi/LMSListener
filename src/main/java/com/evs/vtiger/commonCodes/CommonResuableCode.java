...
public class CommonResuableCode extends CommonOrReuseableCodes{
	...
	public void uploadfile(String photolocation) throws InterruptedException
	{
		kc.myclick(getResourceButton());
		kc.myclear(getChooseFile(), "profilephotoclear");
		kc.mySenkeys(getChooseFile(), photolocation);
		Thread.sleep(3000);
		kc.myclick(getUploadButton());
		Thread.sleep(5000);
	}
	
	public void uploadprofileimage(String profilelocation)
	{
		kc.myclick(getProfilebutton());
		kc.myclick(getProfilelink());
		kc.mySenkeys(getchooseprofile(), profilelocation);
		kc.myclick(getProfileUploadBT());
	}
	
	public void uploadlogo(String chooselogo)
	{
		kc.myclick(getProfilebutton());
		kc.myclick(getSettingLk());
		kc.myclick(getmanagelogoLink());
		kc.mySenkeys(getChooseLogo(), chooselogo);
		kc.myclick(getUploadlogobutton());
	}
	
	public void gotomanageAdminpage()
	{
		kc.myclick(getManagequicklink());
		kc.myclick(getManageAdminAddbutton());
		
	}
	
	public void takeLmslogoscreenshot() throws IOException
	{
	 kc.takesScreenshotofparticularElement(getTakesLMslogo(), "LMSlogo", "C://Users//CBPC-09//Desktop//TakeScreenshot//LMSlogo");	
	}
	
	public void gotoAddcoursePage()
	{
		kc.myclick(getCoursemanagementLK());
		kc.myclick(getUniversalAddbutton());
	}
...
//	}
	...
	public void gotoEmployeepage()
	{
		...
		kc.myclick(getEmployee());
		kc.myclick(getAddbutton());
	}
	
	public void Employeesavebutton()
	{
		kc.myclick(getSaveButton());
	}

	public void uploaresource()
	{
		kc.myclick(getResourceButton());
