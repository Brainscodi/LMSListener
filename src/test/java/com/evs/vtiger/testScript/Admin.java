...
public class Admin extends BaseClass{
	@Test( invocationCount = 10,enabled = true,retryAnalyzer = RetryAnalyzer.class)
	...
	public void uploadfile() throws InterruptedException
	{
		...
		cd.uploadfile("C:\\Users\\CBPC-09\\Pictures\\Saved Pictures\\240_F_52616703_6s0dww8NUINMNDtAHWytqW5JMtFrzFXv.jpg");
	}
	@Test(enabled = true,retryAnalyzer = RetryAnalyzer.class)
	public void uploadlogo()
	{
		CommonResuableCode cd=		new CommonResuableCode(kw);
		cd.uploadlogo("C:\\Users\\CBPC-09\\Pictures\\Saved Pictures\\Kishan.png");
	}
